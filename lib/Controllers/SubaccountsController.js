...
class SubaccountsController {
     ...
     *
     * @param {Enableordisablesubacoount} body enable or disable subaccount
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateSubaccountsPATCH(body, callback) {
...
module.exports = SubaccountsController;
